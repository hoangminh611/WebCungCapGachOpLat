                         ...
                         <div class="panel-body">
                            <form class="form-horizontal bucket-form" enctype="multipart/form-data"  id="edit-form" method="post" action="{{route('Update_Error_Product')}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" value="{{$export_product[0]->error_quantity}}" name= "error_quantity" class="form-control" style="border-top: 1px solid black;" rpattern="[0-9]*" maxlength='10' required="" title=" nhập từ 0 tới 10 chữ số">
                                    </div>
