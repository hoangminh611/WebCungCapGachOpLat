    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                @endif
                @if ($staff->category_permission === 1)
                    <li class="sub-menu">
                        <a href="javascript:void(0);">
                ...
                @endif
                @if ($staff->import_product_permission === 1)
                    <li >
                ...
                @endif
                @if($staff->error_product_permission === 1)
                     <li >
                ...
                @endif
                @if($staff->discount_permission === 1)
                     <li >
